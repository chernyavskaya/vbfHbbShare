...
#
	...
	mg2.add_option('--lumi',help=colours[5]+'Luminosity: 2190.,2190. (Single,Double)'+colours[0],default=[2190.,2190.],type='str',action='callback',callback=optsplitfloat,dest='LUMI')
	...
	mg2.add_option('--BRN',help=colours[5]+'Bernstein order: 5,4 (Single,Double)'+colours[0],default=[5,4],type='str',action='callback',callback=optsplitint)
...
#### Start of RooFit part 
  ...
  ### QCD part
	  ...
	  ### Define cut
			...
			cutB   = TCut("mva%s>%.2f && mva%s<=%.2f && mbbRegFSR>100 && mbbRegFSR<150"%(S.tag,S.boundaries[C],S.tag,S.boundaries[C+1]))
	  ### Draw
	  		c0.cd()
